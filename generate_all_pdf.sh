...
mv gcompris-teachers-handbook.pdf ${output_folder}/gcompris-teachers-handbook-${locale}.pdf
...
for folder in po/*; do
    ...
    cp -R ${base_dir}/po/${locale}/docs/gcompris-teachers-handbook/* ${gen_folder}
    ${base_dir}/docs-kde-org/buildpdf.sh ${gen_folder}/index.docbook
    # The pdf name is the tmp folder name
    mv ${gen_folder}/*.pdf ${output_folder}/gcompris-teachers-handbook-${locale}.pdf
    popd
    rm -rf ${gen_folder}
done
